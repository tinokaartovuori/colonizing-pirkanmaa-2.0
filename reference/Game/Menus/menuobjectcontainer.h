...
#                                                                    #
# File: menuobjectcontainer.h, header for MenuObjectContainer class  #
#                                                                    #
...
#ifndef MENUOBJECTCONTAINER_H
#define MENUOBJECTCONTAINER_H
...
/**
 * @brief The MenuObjectContainer class is a base-class for different Tile-objects
 * in the game. \n
 *
 ...
 */
class MenuObjectContainer : public Student::MenuObject, public Student::iContainer
{
public:
    ...
    MenuObjectContainer(const Course::Coordinate &coordinate,
             int width,
             int height,
             int gridSize,
     ...
     */
    virtual ~MenuObjectContainer() = default;
...
}; // class MenuObjectContainer

} // namespace Course


#endif // MENUOBJECTCONTAINER_H
