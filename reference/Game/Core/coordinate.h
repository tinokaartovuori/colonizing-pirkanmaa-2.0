...
#                                                                    #
# File: coordinate.h, header for Coordinate-class                    #
#                                                                    #
...
public:
     ...
     * @post Exception guarantee: Strong
     */
    std::vector<Coordinate> neighbours(const int radius,
                                       const int width,
                                       const int height) const;


    std::vector<Coordinate> neighbouringFour(const int width,
                                             const int height) const;

    std::map<std::string, Coordinate> neighbouringFourMap(const int width,
                                                          const int height) const;
