...
#                                                                    #
# File: placeablegameobject.h, header for PlaceableGameObject-class  #
#                                                                    #
...
public:
     ...
     */
    explicit PlaceableGameObject(const std::weak_ptr<iGameEventHandler>& eventhandler,
