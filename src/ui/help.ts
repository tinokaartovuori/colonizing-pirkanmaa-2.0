...
<h3>How to win</h3>
<p>Win by being the last player standing &mdash; either own <b>70%</b> of all tiles, or conquer every rival's headquarters.</p>
...
<ul>
  ...
  <li><u>Outpost</u> &mdash; cannot be conquered; +3 max soldiers. Grassland / cut forest.</li>
...
<p>Any seat can be filled by the computer at one of three levels:</p>
<ul>
  <li><u>Easy</u> &mdash; grows a small economy and rarely fights. A gentle warm-up.</li>
  <li><u>Medium</u> &mdash; expands steadily, hires experts, and keeps a small garrison.</li>
  <li><u>Hard</u> &mdash; builds aggressively, fields soldiers, and attacks weak neighbours.</li>
</ul>
<p>While a computer takes its turn the panel reads "Thinking&hellip;" &mdash; watch its units and buildings appear on the map.</p>
`;
